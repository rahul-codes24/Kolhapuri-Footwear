...
include("connection.php");
        ...
        $a="select * from orderedproduct where extract(YEAR from date)=$year AND extract(MONTH from date)=$month ";
        if($res1=mysqli_query($con,$a)){
            while($row1=mysqli_fetch_array($res1)){
                ...
                $flag=0;
                $b="select * from revenue where month=$month and year=$year";
...
$html .="<table border='1' width='100%' cellspacing='0' cellpadding='10'>
    ...
    $alltotal=0;
    $c="select * from revenue where month=$month and year=$year";
