...
<body>
    ...
    <div class="categeory">
            ...
            <a href="mainproductFemale.php"><button id="catbtnactive">FEMALE</button></a>
            <a href="mainproduct.php"><button id="catbtn">ALL</button></a>
        ...
        include("connection.php");
         ...
         ?>
            ...
            <form name="frm3" action="login.html">
                ...
                <?php echo" <a href='mainproductView.php? id=$row[0] '>"?><img src="<?php  echo $row[3]?>"  alt="Kolhapuri"></a>
