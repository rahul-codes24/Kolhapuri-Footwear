...
<body>
    ...
    <div class="containts ">
        <div class="categeory">
            ...
            <a href="userhomeFemale.php"><button id="catbtnactive">FEMALE</button></a>
            <a href="userhome.php"><button id="catbtn">ALL</button></a>
        ...
        // }
         ...
         $q="select * from addproduct where categeory='Female'";
         ...
         ?>
            <div class="pro-buy1">
                ...
                <div class="buy-img">
                  ...
                  <?php echo" <a href='productView.php? id=$row[pro_id] '>"?> <img src="<?php  echo $row['image']?>" name="image" alt="Kolhapuri"></a>
                </div>
                <div class="buy-text">
